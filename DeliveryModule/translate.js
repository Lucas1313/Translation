...
var copydir = require('copy-dir');
	...
	// //NOT AVAILABLE YET
	try { copydir.sync('./Target-Czech (Czech-Republic)/en-us');} catch(err){ copydir.sync('./i18n/en-us', './i18n/cs-cz/'); };
	try { copydir.sync('./Target-Danish (Denmark)/en-us');} catch(err){ copydir.sync('./i18n/en-us', './i18n/da-dk/'); };
	...
	try { copydir.sync('./Target-Spanish (Argentina)/en-us'); } catch(err){ copydir.sync('./i18n/en-us', './i18n/es-ar/'); };
	copydir.sync('./i18n/es-ar', './i18n/es-uy/');

	try { copydir.sync('./Target-Spanish (Colombia)/en-us'); } catch(err){ copydir.sync('./i18n/en-us', './i18n/es-co/'); };
